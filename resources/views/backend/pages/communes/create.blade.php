                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="{{route('regions.store')}}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group form-show-validation row">
                                    <label for="email" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Province <span class="required-label">*</span></label>
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                                        <select id="region" class="form-control dynamic" name="region">
                                ...
                                <div class="form-group form-show-validation row">
                                    <label for="libelle" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Commune: <span class="required-label">*</span></label>
                                    <div class="col-lg-4 col-md-9 col-sm-8">
                            ...
                            <div class="card-action">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <a type="button" class="btn btn-danger btn-round ml-auto" href="{{route('communes.index')}}">Retour</a> 
