                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-title">Créer une direction</div>
                                <div class="card-category">Ajouter une direction</div>
                            </div>
                                    ...
                                    <div class="card-action">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <a type="button" class="btn btn-danger btn-round ml-auto" href="{{route('directions.index')}}">Retour</a> 
