        ...
        <div class="content">
            <div class="page-inner">
                <div class="page-header">
                    <h4 class="page-title">Nos Directions</h4>
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    <h4 class="card-title">Liste des directions</h4>                           
                                        <a class="btn btn-primary btn-round ml-auto" href="{{route('directions.create')}}"><i class="fa fa-plus"></i> Ajouter</a>                                  
                                </div>
                            </div>
                            <div class="card-body">
