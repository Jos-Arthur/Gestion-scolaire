                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-category">Modifier du Profil</div>
                            </div>
                            <form method="POST" action="{{route('profils.update',$profils->id)}}">
                                @csrf
                                @method('PATCH')
                                <div class="card-body">
                                    <div class="form-group form-show-validation row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-8">
                                            <input type="text" class="form-control" id="libelle" name="libelle" placeholder="Libelle" value="{{$profils->libelle}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-show-validation row">
                                        ...
                                        <div class="col-lg-4 col-md-9 col-sm-8">
                                             <textarea type="text" class="form-control" id="commentaire" placeholder="Commentaire" rows="5"  name="commentaire">{{$profils->commentaire}}</textarea>
