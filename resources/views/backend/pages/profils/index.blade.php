        ...
        <div class="content">
            <div class="page-inner">
                <div class="page-header">
                    <h4 class="page-title">Nos Profils</h4>
                            ...
                            <div class="card-header">
                                <div class="d-flex align-items-center">
                                    <h4 class="card-title">Liste des profils</h4>                           
                                        <a class="btn btn-primary btn-round ml-auto" href="{{route('profils.create')}}"><i class="fa fa-plus"></i> Ajouter</a>                                  
                                </div>
                            </div>
                            <div class="card-body">
